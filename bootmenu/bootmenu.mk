...
# recovery tools
PRODUCT_COPY_FILES += \
    ${bm_device}/bootmenu/recovery/sbin/recoveryexit.sh:recovery/root/sbin/recoveryexit.sh \
    ${bm_device}/bootmenu/config/busybox.fstab:recovery/root/etc/fstab \

# general config file to move elsewhere
PRODUCT_COPY_FILES += \
    ${bm_device}/bootmenu/config/profile:system/etc/profile \
    ${bm_device}/bootmenu/config/busybox.fstab:system/etc/fstab
