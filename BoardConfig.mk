...
# enabling this will also update the device tree (kernel Android.mk)
...
#	  LINUXVER=$(shell strings "$(KERNEL_OUT)/vmlinux"|grep '2.6.'|head -n1) \
...
#Camera
BOARD_CAMERA_CUSTOM_PARAMETERS := true
...
COMMON_GLOBAL_CFLAGS += -DBINDER_COMPAT -DEGL_ALWAYS_ASYNC -DMISSING_GRALLOC_BUFFERS
USE_OPENGL_RENDERER := true
BOARD_NO_ALLOW_DEQUEUE_CURRENT_BUFFER := true
BOARD_WITHOUT_HW_COMPOSER := true
BOARD_WITHOUT_PIXEL_FORMAT_YV12 := true
BOARD_CUSTOM_OMX_16BPP_YUV := 27 #.... to check

# Egl Shaders rewrite engine :)
