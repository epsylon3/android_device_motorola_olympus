...
# fix this up by examining /proc/mtd on a running device (must be a multiple of the block size)
BOARD_BOOTIMAGE_PARTITION_SIZE := 8323072
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 8323072
